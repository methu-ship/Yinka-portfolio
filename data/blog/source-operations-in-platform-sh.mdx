...
As humans, we enjoy automating processes a lot and we try to do it as much as we possibly can, basically because it saves a lot of time and it's pretty cool.
