...
tags:
  - "Javascript"
  - "Web Development"
summary: The JavaScript Debugger Statement is used to debug our javascript code. It can be placed inside a function so as to help debug the function whenever we need to.
---
